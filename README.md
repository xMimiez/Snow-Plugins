...
| [Decor](Decor/) | 2.2.0 | Create and equip Decor avatar decorations. | [Install](https://raw.githubusercontent.com/xMimiez/Snow-Plugins/main/Decor/manifest.json) |
...
| [AlwaysAnimate](AlwaysAnimate/) | 1.2.0 | Force animation flags on emoji, avatars, and native chat rows. | [Install](https://raw.githubusercontent.com/xMimiez/Snow-Plugins/main/AlwaysAnimate/manifest.json) |
...
| [VolumeBooster](VolumeBooster/) | 1.2.0 | Boost voice volume via native engine setters and unlocked sliders. | [Install](https://raw.githubusercontent.com/xMimiez/Snow-Plugins/main/VolumeBooster/manifest.json) |
...
| [InstallLinks](InstallLinks/) | 1.0.5 | `snow://` install-plugin links. Preview, install, and enable via Snow’s external plugin API. | [Install](https://raw.githubusercontent.com/xMimiez/Snow-Plugins/main/InstallLinks/manifest.json) |
