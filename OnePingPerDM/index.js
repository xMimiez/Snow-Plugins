var plugin = (() => {
  ...
  var OnePingPerDM_entry_exports = {};
  __export(OnePingPerDM_entry_exports, {
    default: () => OnePingPerDM_entry_default
  });
  ...
  // OnePingPerDM.entry.js
  var OnePingPerDM_entry_default = register({ "id": "mime.onepingperdm", "name": "OnePingPerDM", "description": "Compatibility probe: message-aware native audio hook still required.", "version": "1.1.0", "authors": [{ "name": "ProffDea", "id": "609329952180928513" }, { "name": "Mime | N0_.q3", "id": "957164619061932045" }], "license": "GPL-3.0-or-later", "source": "https://github.com/xMimiez/Snow-Plugins/tree/main/OnePingPerDM" }, OnePingPerDM);
  return __toCommonJS(OnePingPerDM_entry_exports);
})();
