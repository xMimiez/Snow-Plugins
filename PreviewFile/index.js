var plugin = (() => {
  ...
  function PreviewFile(r) {
    const { h, React, RN, D, C } = r, { Page, Text, Button } = ui(r), cache = /* @__PURE__ */ new Map();
    ...
    function Viewer({ a, text, close }) {
      ...
      return h(
        Page,
        { title: a.filename || a.name || "File", close },
    ...
    function wrapSheet(element) {
      ...
      function Sheet(props) {
        const tree = typeof Inner === "function" && !(Inner.prototype && Inner.prototype.render) ? Inner(props) : h(Inner, props);
    ...
    return {
      ...
      Settings() {
        return h(Page, { title: "PreviewFile" }, h(Text, null, "Hold a message with a text file and choose View file (above Copy text). Shows up to 100 lines."));
      },
      load
    };
  }
  ...
  // PreviewFile.entry.js
  var PreviewFile_entry_default = register({ "id": "mime.previewfile", "name": "PreviewFile", "description": "View file from the message long-press sheet, above Copy text.", "version": "2.2.4", "authors": [{ "name": "mafu", "id": "519760564755365888" }, { "name": "Mime | N0_.q3", "id": "957164619061932045" }], "license": "GPL-3.0-or-later", "source": "https://github.com/xMimiez/Snow-Plugins/tree/main/PreviewFile" }, PreviewFile);
