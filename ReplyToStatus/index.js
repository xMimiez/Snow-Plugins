...
` : "";
    ...
    function wrapHeader(element) {
      ...
      return h(
        ...
        h(
          RN.View,
          { style: { position: "absolute", top: 4, right: 44, zIndex: 50 }, pointerEvents: "box-none" },
  ...
  // ReplyToStatus.entry.js
  var ReplyToStatus_entry_default = register({ "id": "mime.replytostatus", "name": "ReplyToStatus", "description": "Reply button on the top-right of the profile card.", "version": "2.2.6", "authors": [{ "name": "Mime | N0_.q3", "id": "957164619061932045" }], "license": "MIT", "source": "https://github.com/xMimiez/Snow-Plugins/tree/main/ReplyToStatus" }, ReplyToStatus);
