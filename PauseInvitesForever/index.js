var plugin = (() => {
  ...
  function PauseInvitesForever(r) {
    ...
    function Confirm({ guildId, pause, close }) {
      ...
      return h(
        Page,
        { title: pausing ? "Pause server invites indefinitely?" : "Resume server invites?", close },
    ...
    return {
      ...
      Settings() {
        return h(Page, { title: "PauseInvitesForever" }, h(Text, null, "Use /pauseinvites or /resumeinvites in a server. Each command opens its own confirmation."));
      },
      Confirm
    };
  }
  ...
  // PauseInvitesForever.entry.js
  var PauseInvitesForever_entry_default = register({ "id": "mime.pauseinvitesforever", "name": "PauseInvitesForever", "description": "Pause and resume server invites with explicit confirmation.", "version": "1.2.0", "authors": [{ "name": "Dolfies", "id": "852892297661906993" }, { "name": "amia", "id": "142007603549962240" }, { "name": "Mime | N0_.q3", "id": "957164619061932045" }], "license": "GPL-3.0-or-later", "source": "https://github.com/xMimiez/Snow-Plugins/tree/main/PauseInvitesForever" }, PauseInvitesForever);
