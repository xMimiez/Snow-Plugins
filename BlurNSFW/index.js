var plugin = (() => {
  ...
  // BlurNSFW.entry.js
  var BlurNSFW_entry_exports = {};
  __export(BlurNSFW_entry_exports, {
    default: () => BlurNSFW_entry_default
  });
  ...
  // BlurNSFW.entry.js
  var BlurNSFW_entry_default = register({ "id": "mime.blurnsfw", "name": "BlurNSFW", "description": "Tap-to-reveal sensitive media on supported mobile components.", "version": "1.2.0", "authors": [{ "name": "Vendicated", "id": "343383572805058560" }, { "name": "Mime | N0_.q3", "id": "957164619061932045" }], "license": "GPL-3.0-or-later", "source": "https://github.com/xMimiez/Snow-Plugins/tree/main/BlurNSFW" }, BlurNsfw);
  return __toCommonJS(BlurNSFW_entry_exports);
})();
