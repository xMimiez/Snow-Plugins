(() => {
  ...
  function MoreCommands(r) {
    const { Page, Text } = ui(r);
    return { start() {
    }, Settings() {
      return r.h(Page, { title: "MoreCommands \u2192 GifRoulette" }, r.h(Text, null, "MoreCommands has moved to GifRoulette. Install and enable GifRoulette for /gifroulette. All other old commands have been removed. This migration entry does not register duplicate commands."));
    } };
  }

  // MoreCommands.entry.js
  register({ "id": "mime.morecommands", "name": "MoreCommands", "description": "Migration entry: MoreCommands moved to GifRoulette; all other commands removed.", "version": "2.0.0", "authors": [{ "name": "Mime | N0_.q3", "id": "957164619061932045" }], "license": "MIT", "source": "https://github.com/xMimiez/Snow-Plugins/tree/main/MoreCommands", "capabilities": ["ui"], "dependencies": [] }, MoreCommands);
})();
