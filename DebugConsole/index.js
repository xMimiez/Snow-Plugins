...
${e.text}`).join("\n\n") || "Console is clear.";
  ...
  // DebugConsole.entry.js
  var DebugConsole_entry_default = register({ "id": "mime.debugconsole", "name": "DebugConsole", "description": "Readable live logs with clear, copy, search and severity filters.", "version": "2.2.0", "authors": [{ "name": "Mime | N0_.q3", "id": "957164619061932045" }], "license": "MIT", "source": "https://github.com/xMimiez/Snow-Plugins/tree/main/DebugConsole" }, DebugConsole);
